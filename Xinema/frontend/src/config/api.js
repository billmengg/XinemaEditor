...
export const apiEndpoints = {
  ...
  thumbnail: (character, filename) => apiUrl(`thumbnail/${character}/${filename}`),
  duration: (character, filename) => apiUrl(`duration/${character}/${filename}`),
  frame: (character, filename, frameNumber) => apiUrl(`frame/${character}/${encodeURIComponent(filename)}/${frameNumber}`),
  frameDirect: (character, filename, frameNumber) => apiUrl(`frame-direct/${character}/${encodeURIComponent(filename)}/${frameNumber}`),
